 ...
 */
class ChequeCommand(plugin: Man10EconomyNote?) : CommandExecutor {
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<String>): Boolean {
        ...
        if (args.size == 1) {
            ...
            try {
                ...
                if (plugin!!.vault!!.getBalance(p.uniqueId) < i) {
                ...
                plugin!!.createLog(res.id, p.name, p.uniqueId, "CreateCheque", i.toDouble())
